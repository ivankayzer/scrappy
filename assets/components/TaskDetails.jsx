              ...
              <span className="relative z-0 inline-flex shadow-sm rounded-md">
                ...
                >
                  All activity
                    ...
                    <div
                        className="mt-10 bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
...
TaskDetails.propTypes = {
    ...
    history: PropTypes.arrayOf(PropTypes.shape(eventPropTypes)).isRequired,
};
